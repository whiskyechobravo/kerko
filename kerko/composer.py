...
class Composer:
    ...
    def __init__(
        ...
        :param str default_tag_whitelist_re: Regex to use to whitelist tags. See
            ...
            by Kerko. Note that citation exports (downloads) always include all
            tags regardless of this parameter, which only applies to information
        ...
        :param str default_child_whitelist_re: Regex to use to whitelist
            ...
            unless `blacklist_re` is set and causes some to be rejected.
        ...
        :param str default_child_blacklist_re: Regex to use to blacklist
            ...
            by the extractor. If empty, no children will be rejected unless
            `whitelist_re` is set and the tags of those children don't it. By
            default, any child having at least one tag that begins with an
            underscore ('_') is rejected.
